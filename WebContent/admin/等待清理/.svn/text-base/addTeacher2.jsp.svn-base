    ...
    <head>
        ...
        <script type="text/javascript" charset="utf-8">
			...
			function refresh(val){
				...
				$("#nextBtn").attr("disabled",step==2);
				$("#prevBtn").attr("disabled",step==0);	
        ...
        <div id="form">
             ...
             <fieldset id="field1" >
                ...
                <form  action="imageUpload.action" method="post" enctype="multipart/form-data">
                                <span>选择头像</span><br/>
                                <img id="avatarUpload" style="max-width:300px" onerror="this.src='css/static/avatar.png'" src=../upload/${attachmentFileName}>
                                <br/>
                                <input id="fileAddress" type="file" name="attachment"/>
